...
function AccountsPayable({ token, decodeUserIdRegister, selectedBranch, defaultDates, registrationDate, transactionDate }: AccountsPayableProps) {
    ...
    return (
        <div>
            ...
            <h3 className='text-center text-primary-emphasis'>Selecciona la cuenta por pagar</h3>
            <div>
            ...
            <div className={`${styles.container__Accounts_Receivable} mt-3 mb-3`}>
                {selectedCXP && (
                    <div>
                        <h3 className="text-primary-emphasis">Información de la Cuenta por Pagar</h3>
